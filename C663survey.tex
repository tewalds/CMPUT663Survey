...
- buffered\\
- brokers\\
- not a single address, could be multiple emails, devices or people\\
- not pub/sub, no advertisements\\
...
- low latency or high coupling\\
- synchronous calls

HTTP - imagine HTTP was done over PADRES\\
- synchronous\\
- unbuffered\\
- no brokers\\
